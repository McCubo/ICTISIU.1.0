...
import sv.edu.ufg.icti.siu.beans.TipocontratacionFacade;
import sv.edu.ufg.icti.siu.control.util.JsfUtil;
import sv.edu.ufg.icti.siu.entidades.Tipocontratacion;

@FacesConverter(value = "tipocontratacionConverter")
public class TipocontratacionConverter implements Converter {

    @Inject
    private TipocontratacionFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Tipocontratacion) {
            ...
            return getStringKey(o.getIdtipocontra());
        } else {
