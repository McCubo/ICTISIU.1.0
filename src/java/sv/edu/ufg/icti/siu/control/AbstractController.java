...
import sv.edu.ufg.icti.siu.beans.AbstractFacade;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void guardarDirecto(T entidad){
        this.ejbFacade.create(entidad);
